  ...
  grunt.initConfig({
    ...
    concat: {
      dist: {
        files: [{
          ...
          '<%= meta.build %>js/libs.js': ['<%= meta.scripts %>libs/jquery-2.1.4.js', '<%= meta.scripts %>libs/handlebars-v4.0.5.js', '<%= meta.scripts %>libs/chart.min.js', '<%= meta.scripts %>libs/plugins/*.js', '<%= meta.scripts %>libs/plugins/bootstrap/*.js'],
    ...
    uglify: {
      ...
      dist: {
        files: [{
          '<%= meta.build %>js/modernizr.js': ['<%= meta.scripts %>libs/modernizr.2.8.3.js','<%= meta.scripts %>libs/detectizr.js'],
          '<%= meta.build %>js/script.js': ['<%= meta.scripts %>l10n.js', '<%= meta.scripts %>libs/jquery-2.1.4.js', '<%= meta.scripts %>libs/handlebars-v4.0.5.js', '<%= meta.scripts %>libs/Chart.min.js', '<%= meta.scripts %>libs/plugins/*.js', '<%= meta.scripts %>site.js', '<%= meta.scripts %>plugins/*.js']
        }]
      }
    },
    usemin: {
